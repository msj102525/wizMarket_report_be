...
CREATE TABLE
    `REPORT` (
        ...
        `LOC_INFO_RESIDENT_K` INT NULL COMMENT '입지 분석 주거인구 수 (K)',
        `LOC_INFO_WORK_POP_K` INT NULL COMMENT '입지 분석 직장인구 수 (K)',
        `LOC_INFO_MOVE_POP_K` INT NULL COMMENT '입지 분석 유동인구 수 (K)',
        `LOC_INFO_SHOP_K` INT NULL COMMENT '입지 분석 업소수 (K)',
